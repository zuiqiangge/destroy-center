...
<html>
		 ...
		 <script type="text/javascript">
				...
				function chaiquan(){
					...
					if(button.length==0)
						...
						var is = confirm("确定要撤出？所有记录都将变成未归档");
						if(is){
							$.ajax({
		   						type: "POST",
		   						url: "chaiJuan.do",
				...
				function jiaru(){
					if(confirm("立即跳往未归档页面进行编目操作？"))
						location.href="toListFilesWei.do";
				}
	...
	<body>
	<!-- 条件输入框 -->	
  	<form class="form-inline" role="form" id="conditionForm" action="toListFilesYi.do">
		...
		<input type="button" value="查询" class="btn btn-primary btn-lg" onclick="query()">
	</form>  
	<!--快捷操作按钮--> 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div class="btn-group btn-group-lg">
    <button type="button" class="btn btn-default tooltip-test" data-toggle="tooltip" title="加入当前卷" onclick="jiaru()"><span class="glyphicon glyphicon-plus-sign"></span></button>
